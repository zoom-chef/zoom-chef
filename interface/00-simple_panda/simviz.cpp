...
// redis keys
constexpr const char *world_file = "./resources/world_panda_gripper.urdf";
...
void simulation(Sai2Model::Sai2Model *robot, Sai2Model::Sai2Model* spatula, Simulation::Sai2Simulation *sim, 
...
int main(int argc, char **argv)
{
	...
	std::thread sim_thread(simulation, robot, spatula, sim, ui_force_widget);
...
//------------------------------------------------------------------------------
void simulation(Sai2Model::Sai2Model *robot, Sai2Model::Sai2Model* spatula, Simulation::Sai2Simulation *sim, UIForceWidget *ui_force_widget)
{
